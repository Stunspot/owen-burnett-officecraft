...
def main():
    ...
    checks=[one==two,len(routes)==19,result['local_http']['all_200'],routes['404.html']['page_not_found_text'],result['asset_distinct']['hashes'],result['asset_distinct']['ratios'],not any(v['push'] or v['pull_request'] or v['schedule'] for v in workflows.values()),result['governed_candidate']=={'file_count':125,'fingerprint':'637eb2a5928cd5b1858775f4cae480de91424ec5cdb3d5b9c50bc85ffed74c85'},result['governed_worktree_clean']]
