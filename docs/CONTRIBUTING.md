...
Use a focused GitHub issue for reproducible defects. Security-sensitive material follows [SECURITY.md](SECURITY.md). Contributions are accepted under the repository [MIT License](https://github.com/Stunspot/owen-burnett-officecraft/blob/main/LICENSE.md).